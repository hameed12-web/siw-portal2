...
if not RAW_DATABASE_URL:
    DATABASE_URI = 'sqlite:///siw_balochistan_system.db'
else:
...
class TrainingCenter(db.Model):
    __tablename__ = 'siw_centers_registry'
