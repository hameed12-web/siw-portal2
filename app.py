...
app = Flask(__name__)
app.secret_key = os.environ.get('SECRET_KEY', 'siw-balochistan-2026-master-key')
...
def admin_dashboard():
    ...
    # FIXED DATA FLATTENING LAYER: Injects dynamic properties cleanly before sending to view
    processed_centers = []
    extra_keys = set()
